...
static void sort_rev(t_root **r, int *flags) {
    if (flags[4] == 1)
        mx_merge_sort1_r_root(r);
    else if (flags[13] == 1 && flags[5] == 1)
        mx_merge_sort2_r_root(r);
    else if (flags[7] == 1 && flags[5] == 1)
        mx_merge_sort3_r_root(r);
    else if (flags[5] == 1)
        mx_merge_sort4_r_root(r);
    else
...
static void sort_r(t_root **r, int *flags) {
    ...
    if (flags[15] == 1) {
        ...
        if (flags[4] == 1)
            mx_merge_sort1_root(r);
        else if (flags[13] == 1 && flags[5] == 1)
            mx_merge_sort2_root(r);
        else if (flags[7] == 1 && flags[5] == 1)
            mx_merge_sort3_root(r);
        else if (flags[5] == 1)
            mx_merge_sort4_root(r);
        else
