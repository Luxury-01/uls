...
static void get_hard_l_len(t_file **file, t_flagl_limits **ret) {
...
static void get_name_len(t_file **file, t_flagl_limits **ret) {
...
static void get_g_len(t_file **file, t_flagl_limits **ret) {
...
static void get_size_len(t_file **file, t_flagl_limits **ret) {
